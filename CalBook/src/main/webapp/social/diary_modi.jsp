               ...
               <div class="avatar-upload">
                  <div class="avatar-edit">
                   ...
                   <div class="avatar-preview">
                      ...
                      <c:if test="${com.url != null}">                   
                          <div id="imagePreview" style="background-image: url(upload/${com.url});"></div>
                      </c:if>
                   </div>
               </div>
                <!-- </div> -->
               <textarea name="content" rows="30" style="width: 100%;">${com.content}</textarea>
              </main>
              <hr>
              <div class="bottom">
                 ...
                 <input type="hidden" name="url" value="${com.url}">
                 <button type="submit" class="check">Check</button>
                 <span>|</span>
                 <a href="diary_detail.do?cEmail=${cEmail}&pg=${pg}&query=${urlquery}&seq=${seq}"><button class="delete">Back</button></a>
              </div>
