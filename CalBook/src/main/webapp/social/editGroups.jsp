...
<script type="text/javascript">
	...
	function printData(resData){
		...
		for(var i in resData){
			...
			}else if(resData[i]['status_accept']==-1){
				s += '<button class="btnCheckGroupM" type="button"><i class="fa fa-check-circle-o"></i></button>';
			}else if(resData[i]['status_accept']==0){
				s += '<button class="btnCancelGroupM" type="button"><i class="fa fa-close"></i></button>';
				s2 += '<span>'+resData[i]['email']+'  <i class="fa fa-user-plus"></i></span>';
			}
...
<div class="row">
  ...
  <div class="column middle">  
				...
				<figure class="snip1157">
					...
					<c:if test="${m.profile != null}">
		  			...
		  			<div class="author">
		    			...
		    			<c:if test="${m.status_accept == 1}">
		    				<br><span style="color:yellow">이미 초대하였습니다.</span>
		    			</c:if>
		  			</div>
				</figure>
			</c:forEach>
    ...
    <div class="column half">
		...
		<div class="newGroup">
			<h1>모임 수정</h1>
			<form action="updateGroupsProc.do" method="post">
				<span>모임명 : <input type="text" name="name" value="${g.name}"></span>
				<span>모임내용 : <input type="text" name="content" value="${g.content}"></span>
				...
				<table>
	              ...
	              <col style="width:47%;">
	              <tr>
	                 <td><button class="groupButton" type="submit"><span class="move">수정완료</span></button></td>
	                 <td></td>
	                 <td><a href="createGroupCancelProc.do?g_num=${g.num}"><span class="move">수정취소</span></a></td>
	              </tr>
	           	</table>
         	</form> 	
		</div>
